...
final class HardCollisionParity {
    ...
    static void verify(GameTestHelper helper) {
        ...
        extras.add(CollisionTestSupport.spawnEntity(helper, EntityType.BOAT, anchor.add(0.3, 0.0, 0.0)));
        extras.add(CollisionTestSupport.spawnEntity(helper, EntityType.BOAT, anchor.add(source.getBbWidth() + 0.4, 0.0, 0.0)));
        extras.add(CollisionTestSupport.spawnZombie(helper, anchor.add(0.0, 0.0, 3.0)));
        Entity boatSource = CollisionTestSupport.spawnEntity(helper, EntityType.BOAT, anchor.add(0.0, 0.0, 0.4));
