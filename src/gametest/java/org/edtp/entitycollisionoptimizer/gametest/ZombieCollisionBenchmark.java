...
public final class ZombieCollisionBenchmark {
    ...
    public void stackedZombies(GameTestHelper helper) {
        ...
        EntityCollisionOptimizer.LOGGER.info(
                "ECO_BENCHMARK_START entities={} scenario=stacked_zombies samples_per_mode=400 "
    ...
    private static void onTickStart(MinecraftServer server) {
        ...
        CollisionOptimizerConfig.enableEntityCollision = phase.optimized;
    ...
    private static void onTickEnd(MinecraftServer server) {
        ...
        if (phase.optimized && !run.directedEdgesVerified) {
            ...
            EntityCollisionOptimizer.LOGGER.info(
                    "ECO_BENCHMARK_COLLISION_MAP verified_directed_edges={}",
                    actualDirectedEdges
            );
        }
        if (phase.measured) {
