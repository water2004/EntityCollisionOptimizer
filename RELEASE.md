...
工作流会在 Windows 上使用 Microsoft Build of OpenJDK 25，交叉编译 Windows、Linux 和 macOS x64 原生库，构建 Fabric JAR，并校验 JAR 内版本号及原生库是否完整。成功后创建 GitHub Release，附加主 JAR、源码 JAR 和 SHA-256 校验文件。`alpha` 版本标记为 Pre-release，正式版标记为 Latest release。
