...
- Profiling changes runtime load. CPU shares describe the instrumented run, not an exact decomposition of uninstrumented MSPT. Keep performance A/B runs separate and generated captures/reports outside the repository.
